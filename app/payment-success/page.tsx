...
import { CheckCircle2, Package, Truck, Mail, Check } from "lucide-react";
            ...
            {paymentStatus === "success" && (
              <>
                ...
                {!emailSent ? (
                  ...
                  <div className="max-w-md mx-auto bg-green-50 dark:bg-green-950/50 p-4 rounded-lg border border-green-200 dark:border-green-800">
                    <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
                      <Check className="h-5 w-5" />
                      <p className="font-medium">Confirmation email sent to {email}</p>
                    </div>
                    <p className="text-sm text-muted-foreground mt-2">
                      Please check your inbox for the order details and shipping information.
                    </p>
                  </div>
                )}
              </>
