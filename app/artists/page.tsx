  ...
  return (
    <main className="min-h-screen py-16 px-4 md:px-8">
      ...
      <section className="max-w-7xl mx-auto mb-16 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">Our Artists</h1>
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="painters">
            <ArtistGrid specialty="Painter" />
          </TabsContent>
          <TabsContent value="sculptors">
            <ArtistGrid specialty="Sculptor" />
          </TabsContent>
          <TabsContent value="photographers">
            <ArtistGrid specialty="Photographer" />
          </TabsContent>
          <TabsContent value="digital">
            <ArtistGrid specialty="Digital Artist" />
          </TabsContent>
        </Tabs>
      </section>
    </main>
