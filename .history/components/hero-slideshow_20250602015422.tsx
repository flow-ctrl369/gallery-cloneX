      ...
      <AnimatePresence mode="sync">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-8 right-8 text-white bg-black/40 backdrop-blur-sm p-4 rounded-lg max-w-[200px]"
          >
            <h2 className="text-lg font-semibold mb-1 line-clamp-1">{artworks[currentIndex].title}</h2>
            <p className="text-sm mb-3">by {artworks[currentIndex].artist}</p>
            <Button 
              variant="outline" 
              asChild 
              className="w-full bg-black/10 text-white hover:bg-black/20 border-white text-sm py-1"
            >
