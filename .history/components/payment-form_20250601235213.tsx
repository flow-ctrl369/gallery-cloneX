...
interface StripePaymentFormProps {
  ...
  clientSecret: string | null; // Client secret from parent
  handlePaymentSubmit: () => Promise<void>; // Submit handler from parent
}

function StripePaymentForm({ options, error, setError, isProcessing, clientSecret, handlePaymentSubmit }: StripePaymentFormProps) {
    ...
    <div className="container max-w-lg mx-auto px-4 py-8">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <Form {...form}>
            <form onSubmit={currentStep === 2 ? form.handleSubmit(handlePaymentSubmit) : (e) => e.preventDefault()} className="space-y-6">
              {currentStep === 1 ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {clientSecret && (
                      ...
                      >
                       ...
                       }} error={formError} setError={setFormError} isProcessing={isProcessing} clientSecret={clientSecret} handlePaymentSubmit={handlePaymentSubmit} />
                      </Elements>
                    )}
                  </div>
                )}
