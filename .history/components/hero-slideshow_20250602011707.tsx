      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-8 right-8 text-white bg-black/40 backdrop-blur-sm p-6 rounded-lg max-w-md"
          >
            ...
            <Button 
              variant="outline" 
              asChild 
              className="w-full bg-black/10 text-white hover:bg-black/20 border-white"
            >
