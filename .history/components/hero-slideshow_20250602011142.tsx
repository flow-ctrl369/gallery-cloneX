...
// Define which slides should use dark text
const darkTextSlides = [0, 2, 4] // Adjust these indices based on your artwork brightness
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Image
            ...
            fill
            className={`object-cover ${isDarkText ? "brightness-100" : "brightness-75"}`}
            priority
          />
          <div className={`absolute inset-0 ${isDarkText ? "bg-white/30" : "bg-black/30"}`} />
          ...
          <motion.div
            ...
            className={`absolute bottom-8 right-8 ${
              isDarkText ? "text-black bg-white/40" : "text-white bg-black/40"
