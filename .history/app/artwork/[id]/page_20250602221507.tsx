...
export default function ArtworkPage({ params }: ArtworkPageProps) {
  ...
  const options = clientSecret ? {
    ...
    appearance,
    layout: { type: 'tabs' },
    paymentMethodOrder: ['card', 'afterpay_clearpay', 'google_pay'],
  } : undefined;
                  ...
                  <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden">
                    ...
                    {!showPayment ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 h-full divide-x divide-border">
                        {/* Order Summary */}
                        <div className="p-6 md:p-8 bg-gray-900 dark:bg-gray-900 text-gray-50 dark:text-gray-50 space-y-6 flex flex-col justify-between">
