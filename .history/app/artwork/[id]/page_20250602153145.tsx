              ...
              <Button className="flex-1">Purchase</Button>
                  ...
                  <DialogContent className="sm:max-w-[800px]">
                    ...
                    {!showPayment ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 h-full -mx-6 sm:mx-0">
                        {/* Order Summary */}
                        <div className="p-6 md:p-8 bg-muted dark:bg-gray-800 rounded-lg md:rounded-none md:rounded-l-lg flex flex-col justify-between">
