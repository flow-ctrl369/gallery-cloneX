...
function ArtworkContent({ artworkId }: { artworkId: string }) {
  ...
  return (
    <main className="min-h-screen py-8 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <section className="mb-16">
        ...
        <RelatedArtworks currentId={artworkId} category={artwork.category} />
      </section>
    </main>
  )
}
  ...
  return (
    <ErrorBoundary
      onError={(error, errorInfo) => {
        ...
        console.error("Artwork page error:", error, errorInfo)
      }}
    >
      <Suspense 
        fallback={
      ...
      >
        <ArtworkContent artworkId={resolvedParams.id} />
      </Suspense>
    </ErrorBoundary>
  )
}
