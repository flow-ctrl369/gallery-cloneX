      ...
      <main className="min-h-screen">
        ...
        <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold uppercase tracking-wider">Featured Artwork</h2>
        ...
        <section className="py-16 px-4 md:px-8 bg-muted relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <h2 className="text-3xl font-bold mb-4 uppercase tracking-wider">Meet Our Artists</h2>
        ...
        <section id="gallery" className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <h2 className="text-3xl font-bold uppercase tracking-wider">Gallery</h2>
        ...
        <section className="py-16 px-4 md:px-8 bg-muted">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4 uppercase tracking-wider">Stay Updated</h2>
